...
# References:
# https://github.com/kosecki123/alpine-pygrib/blob/master/Dockerfile
...
RUN conda install -c anaconda jupyter pandas numpy matplotlib && \
    conda install -c conda-forge pyproj pygrib netcdf4 && \
